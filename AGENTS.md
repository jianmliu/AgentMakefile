...
- select_context=include=git.diff, active_file, tests
- link_prompt=fragment=superpowers.test-driven-development
- check_guard=write_failing_test_before_production_code
...
- select_context=include=git.diff, review_feedback
- link_prompt=fragment=superpowers.receiving-code-review
